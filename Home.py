...
st.write("It's the first day of your new role as a Data Engineer in the Macrodata Refinement section at the ABS. 'It's restricted down there --like CPI', you overheard someone say. 'What do they _actually_ do?' you enquire. 'Something to do with numbers, I heard... no one really knows.' You figure this sounds like most teams that work at the ABS, so you enter the lift, press the button and then .....")
st.write("... The lift door opens. 'Where am I...?' you wonder. 'Hang on... _who am I...?_' Ahead are several colleagues working at what look like retro 90s style monitors. 'Your job is to find the mysterious number patterns', says someone who appears to be your new section director. 'They may make you feel weird'.") 
...
st.subheader("Challenge Playground")
st.write("You can test your function or play as a human at the [Macrodata Refinement Playground](https://mdr-main.vercel.app/). This interactive environment allows you to:")
"""
- Play manually using arrow keys to navigate and find magic squares
- Test your custom search strategy implementation
- Experiment with different board sizes and magic square quantities
- Enable logging to debug your search algorithm
- Compare your performance with other strategies
"""
