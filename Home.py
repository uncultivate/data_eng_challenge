...
st.write("It's the first day of your new role as a Data Engineer in the Macrodata Refinement section at the ABS. 'It's restricted down there --like CPI', you overheard someone say. 'What do they actually do?' You enquire. 'Something to do with numbers, I heard... no one really knows.' You figure this sounds like most teams that work at the ABS, so you enter the lift, press the button and enjoy the ride.")
st.write("The door opens and you blank out. 'Where am I...?' you wonder. 'Hang on... who am I...?' Ahead are several colleagues working at what look like retro 90s style monitors. 'Your job is to find the mysterious number patterns', says someone who appears to be your new section director. 'They may make you feel weird'.") 
